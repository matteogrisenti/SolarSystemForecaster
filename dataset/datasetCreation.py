...
power_df = pd.read_csv('solar_system_data/solar_power_merged.csv')
...
print("=" * 80)
print("\nYou can now use these datasets to train deep learning models:")
print("1. Feedforward Neural Networks (MLP)")
print("2. Recurrent Neural Networks (LSTM, GRU)")
print("3. Convolutional Neural Networks (CNN)")
print("4. Transformer-based models")
print("5. Hybrid models (CNN-LSTM)")
print("=" * 80)